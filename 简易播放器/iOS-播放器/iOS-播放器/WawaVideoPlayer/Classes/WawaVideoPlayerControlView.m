...
static const CGFloat kVideoCloseControlBarHeight = 60.0;
static const CGFloat kVideoControlBarHeight = 40.0;
static const CGFloat kVideoControlAnimationTimeinterval = 0.3;
static const CGFloat kVideoControlTimeLabelFontSize = 10.0;
static const CGFloat kVideoControlBarAutoFadeOutTimeinterval = 5.0;

@interface WawaVideoPlayerControlView()
...
@end
@implementation WawaVideoPlayerControlView
...
- (void)layoutSubviews
{
    ...
    self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), -8, CGRectGetWidth(self.bounds), kVideoCloseControlBarHeight);
    ...
    self.closeButton.frame = CGRectMake(CGRectGetMinX(self.playButton.bounds) -16, 0, CGRectGetWidth(self.closeButton.bounds), CGRectGetHeight(self.closeButton.bounds));
...
- (UIButton *)closeButton
{
    if (!_closeButton) {
        ...
        _closeButton.bounds = CGRectMake(0, 0, kVideoCloseControlBarHeight, kVideoCloseControlBarHeight);
    }
    return _closeButton;
}
